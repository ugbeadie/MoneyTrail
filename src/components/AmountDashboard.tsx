...
export function AmountDashboard() {
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden md:flex justify-between items-center py-4 w-full md:px-20">
        {/* Column 1: Summary */}
        <div className="flex-1 flex flex-col">
          <h1 className="text-3xl font-semibold text-foreground">Summary</h1>
        </div>

        {/* Column 2: Net Total */}
        <div className="flex-1 flex flex-col text-center">
          <div className="text-sm font-medium mb-2 text-muted-foreground flex justify-center">
            Balance
            <span>
              <Wallet />
            </span>
        ...
        {/* Column 3: Income */}
        <div className="flex-1 flex flex-col text-center">
          <div className="text-sm font-medium mb-2 text-green-600 flex justify-center align-center">
            Income
        ...
        {/* Column 4: Expenses */}
        <div className="flex-1 flex flex-col text-center">
          <div className="text-sm font-medium mb-2 text-red-600  flex justify-center align-center">
            Expenses
            <span>
